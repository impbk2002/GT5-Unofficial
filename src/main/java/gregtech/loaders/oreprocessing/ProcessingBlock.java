...
public class ProcessingBlock implements gregtech.api.interfaces.IOreRecipeRegistrator {
    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
        ...
        if (GregTech_API.sRecipeFile.get(ConfigCategories.Recipes.storageblockcrafting, OrePrefixes.block.get(aMaterial).toString(), true)) {
            if ((tStack1 == null) && (tStack2 == null) && (tStack3 != null)) {
                GT_ModHandler.addCraftingRecipe(bStack, RecipeBits.NOT_REMOVABLE|RecipeBits.BUFFERED, new Object[]{"XXX", "XXX", "XXX", 'X', OrePrefixes.dust.get(aMaterial)});
            }
            if (tStack2 != null) {
                GT_ModHandler.addCraftingRecipe(bStack, RecipeBits.NOT_REMOVABLE|RecipeBits.BUFFERED, new Object[]{"XXX", "XXX", "XXX", 'X', OrePrefixes.gem.get(aMaterial)});
            }
            if (tStack1 != null) {
